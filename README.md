...
Official logo files for **InoSwap** — *Swap smarter* — [inoswap.org](https://inoswap.org).
...
| Color | Hex | Use |
|---|---|---|
| InoSwap | `#EC4C9B` | background of the icon, symbol on light backgrounds |
| Shadow | `#632041` | drop shadow under the symbol only |
