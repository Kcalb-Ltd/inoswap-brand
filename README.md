...
Direct links, for integrations: `https://raw.githubusercontent.com/KcalbApp/inoswap-brand/main/assets/png/round/inoswap-round-500.png`. For production, pin a commit hash instead of `main` and check the file against [asset-manifest.json](asset-manifest.json).
...
Questions and requests: **contact@inoswap.org**, or open an [issue](https://github.com/KcalbApp/inoswap-brand/issues).
