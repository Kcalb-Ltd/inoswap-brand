# InoSwap brand assets

<p>
<img src="assets/png/square/inoswap-square-200.png" width="96" alt="InoSwap app icon">&nbsp;
<img src="assets/png/round/inoswap-round-200.png" width="96" alt="InoSwap round avatar">&nbsp;
<img src="assets/png/symbol-color/inoswap-symbol-color-200.png" width="96" alt="InoSwap symbol">
</p>

Official logo files for **InoSwap** — *Swap smarter. Not harder.* — [inoswap.org](https://inoswap.org).
InoSwap is a brand of [Kcalb Ltd](https://kcalb-ltd.com), part of the KcalbApp ecosystem.
...
Direct links, for integrations: `https://raw.githubusercontent.com/Kcalb-Ltd/inoswap-brand/main/assets/png/round/inoswap-round-500.png`. For production, pin a commit hash instead of `main` and check the file against [asset-manifest.json](asset-manifest.json).

## Official colors

| Color | Hex | Use |
|---|---|---|
| InoSwap | `#E64392` | background of the icon, symbol on light backgrounds |
| Shadow | `#611C3D` | drop shadow under the symbol only |
...
- Refer to the brand as **InoSwap**, with this exact spelling.
...
Copyright © 2026 Kcalb Ltd. All rights reserved — the [LICENSE](LICENSE) allows use of the unmodified files to refer to InoSwap.
Questions and requests: **contact@inoswap.org**, or open an [issue](https://github.com/Kcalb-Ltd/inoswap-brand/issues).
